...
extern "C" __global__ void bm_mean(float *out,
...
extern "C" __global__ void bm_msd(float *out,
...
extern "C" __global__ void bm_central_moment(float *out,
                                             float mean, float start_position,
...
extern "C" __global__ void bm_frac_raw_moment(float *out,
...
extern "C" __global__ void bm_frac_central_moment(float *out,
                                                  float mean, float start_position,
                                                  float diffusivity, float order,
                                                  float duration, float time_step,
                                                  size_t particles,
...
extern "C" __global__ void bm_raw_moment(float *out,
                                         float start_position,
                                         float diffusivity, int order,
                                         float duration, float time_step,
                                         size_t particles,
